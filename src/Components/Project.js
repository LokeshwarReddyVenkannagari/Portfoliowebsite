...
function Project({
  ...
  return (
    <motion.article
      className="rounded-xl mt-10 overflow-hidden shadow-lg transition-transform transform hover:scale-105 duration-300 ease-in-out"
    ...
    >
      ...
      <div className="dark:bg-dark-card p-6">
        <h1 className="dark:text-light-heading font-bold text-xl pt-1">
          {title}
        </h1>
        <p className="text-content pt-4 text-sm text-gray-600 dark:text-gray-400">
          {description}
        </p>
        ...
        <div className="flex justify-between items-center mt-5">
          <div className="flex items-center">
            ...
            <a
              ...
              className="underline pl-2 font-light dark:text-white transition-colors duration-300 hover:text-blue-500 dark:hover:text-blue-400"
            >
              Live Preview
            </a>
          </div>
